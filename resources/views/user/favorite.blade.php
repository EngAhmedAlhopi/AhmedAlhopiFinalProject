...
<section class="pt-5 pb-5">
    <div class="container">
        <div class="row">
            <div class="col-6">
                <h3 class="mb-3">Favorite Laptops </h3>
            </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="lpo">
                                                <a href="#" class="btn btn-primary" style="height: 40px;margin-top: auto;margin-bottom: auto;">Go somewhere</a>
                                                {{-- <a class="btn btn-outline-light btn-floating m-1" href="#"
                                                    role="button"> --}}
                                                    <div class="like">
                                                        <a href="#" class="abc"><i class="like2"></i></a>
                                                        <a href="#" class="abc"><i class="fas fa-shopping-basket"></i></a>
...
<section class="pt-5 pb-5">
    <div class="container">
        <div class="row">
            <div class="col-6">
                <h3 class="mb-3">Favorite Phone </h3>
            </div>
            <div class="col-6 text-right">
                <a class="btn btn-primary mb-3 mr-1" href="#carouselExampleIndicators2" role="button" data-slide="prev">
                    <i class="fa fa-arrow-left"></i>
...
<section class="pt-5 pb-5">
    <div class="container">
        <div class="row">
            <div class="col-6">
                <h3 class="mb-3">Favorite Accessories </h3>
            </div>
            <div class="col-6 text-right">
                <a class="btn btn-primary mb-3 mr-1" href="#carouselExampleIndicators2" role="button" data-slide="prev">
                    <i class="fa fa-arrow-left"></i>
