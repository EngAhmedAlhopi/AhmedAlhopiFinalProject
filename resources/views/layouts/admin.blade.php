            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false"> -->
                            <li><a href="c-nestedable.html">Nestedable</a></li>
                            <li><a href="c-noui-slider.html">Noui Slider</a></li>
                            <li><a href="c-sweetalert.html">Sweet Alert</a></li>
                            <li><a href="c-toastr.html">Toastr</a></li>
                        </ul>
                    </li>
                    <li>
