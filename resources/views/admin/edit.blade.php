...
<form class="form-horizontal" action="/add-product" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            @csrf
            <input id="product_id" name="name" value="{{ $product->name }}" class="form-control input-md" required="" type="text">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            @csrf
            <input id="product_name" name="price" value="{{ $product->prise }}" class="form-control input-md" required="" type="text">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            @csrf
            <textarea class="form-control" id="product_description" name="information">{{ $product->information }}</textarea>
        </div>
    </div>
